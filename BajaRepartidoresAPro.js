...
export default class BajaRepartidoresAPro extends Component {
  constructor(props) {
    super(props);
    this.state = {
        //Variables
  ...
  render() {
    ...
    const borrarRep = (item) => {
        ...
        xhttp.open('GET', 'http://appudeg.xp3.biz/Proyecto/bajaRepartidoresPro.php?id=' + item.id, true);
        xhttp.send();
    };
    ...
    return (
      <View style={styles.container}>
        ...
        <View style={styles.container2}>
            <Text style={styles.title2}> BAJA DE REPARTIDORES </Text>
        </View>
        <Text style={styles.text}> Selecciona al repartidor que deseas eliminar </Text>
        <FlatList
