...
export default class PrincipalAPro extends Component {
  constructor(props) {
    super(props);
    this.state = {};
  }
  ...
  render() {
    ...
    return (
      <View style={styles.container}>
        ...
        <View style={styles.container2}>
            <Text style={styles.title2}> Repartidores </Text>
        </View>
        <Pressable style={styles.button} onPress={btnRepartidores}>
            <Text style={styles.txtBtn}>IR A ESTA SECCIÓN</Text>
        </Pressable>
        <View style={styles.container2}>
