...
export default class RepartidoresAPro extends Component {
  constructor(props) {
    super(props);
    this.state = {};
  }
  ...
  render() {
    ...
    const btnAlta = () => {
        this.props.navigation.navigate('AltaRepAdmin');
    };

    const btnBaja = () => {
        this.props.navigation.navigate('BajaRepAdmin');
    }

    const btnCambio = () => {
        this.props.navigation.navigate('CambioRepAdmin');
    }

    const btnLista = () => {
        this.props.navigation.navigate('ListaRepAdmin');
    }
    ...
    return (
      <View style={styles.container}>
        ...
        <Text style={styles.text}> ¡Menú de Repartidores! </Text>
        <View style={styles.container2}>
            <Text style={styles.title2}> Acciones </Text>
        </View>
        <Pressable style={styles.button} onPress={btnAlta}>
            <Text style={styles.txtBtn}>ALTA DE REPARTIDORES</Text>
        </Pressable>
        <Pressable style={styles.button} onPress={btnBaja}>
            <Text style={styles.txtBtn}>BAJA DE REPARTIDORES</Text>
        </Pressable>
        ...
        <Pressable style={styles.button} onPress={btnLista}>
            <Text style={styles.txtBtn}>LISTA DE REPARTIDORES</Text>
        </Pressable>
