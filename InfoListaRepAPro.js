...
export default class InfoListaRepAPro extends Component {
  constructor(props) {
    super(props);
    this.state = {};
  }
  ...
  render() {
    ...
    return (
      <View style={styles.container}>
        ...
        <Text style={styles.text}> A continuación se muestran los detalles del repartidor seleccionado </Text>
