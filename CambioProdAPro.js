...
export default class CambioProductosAPro extends Component {
  constructor(props) {
    super(props);
    this.state = {
        //Variables
  ...
  render() {
    ...
    const Detalle = (id, nombre, precio, imagen) => {
        this.props.navigation.navigate('Cambio2ProdAdmin', {id: id, nombre: nombre, precio: precio, imagen: imagen});
    }
    ...
    return (
      <View style={styles.container}>
        ...
        <Text style={styles.text}> Selecciona el producto que deseas modificar </Text>
        <FlatList
